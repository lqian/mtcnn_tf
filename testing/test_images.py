...
# 	    maxEpoch = 30
    ...
    mtcnnDetector = MtcnnDetector(detectors=detectors, min_face_size = 24, threshold=[0.92, 0.8, 0.8])
...
def parse_args():
    ...
    parser.add_argument('--gpus', dest='gpus', help='specify gpu to run. eg: --gpus=0,1',
                        default='0', type=str)
    parser.add_argument('--epoch', dest='epoch', help='epoch of checkpoint to be loaded into session', type=int, default=30)
